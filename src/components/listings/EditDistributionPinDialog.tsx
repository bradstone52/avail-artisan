...
interface EditDistributionPinDialogProps {
...
/**
 * Edit pin location dialog for distribution listings (from market_listings table).
 */
export function EditDistributionPinDialog({ 
  listing, 
  open, 
  onOpenChange,
  onSave 
}: EditDistributionPinDialogProps) {
    ...
    const initTimer = setTimeout(async () => {
      ...
      try {
        ...
        const map = new Map(mapContainerRef.current, {
          ...
          zoom,
          mapTypeId: "hybrid",
          mapId: "edit-distribution-pin-map",
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    try {
      // Update market_listings table instead of listings
